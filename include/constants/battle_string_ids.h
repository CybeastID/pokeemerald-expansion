...
enum StringID
{
    ...
    STRINGID_AUTHORITYSTRENGTHENUSER,
    STRINGID_AUTHORITYWEAKENTARGET,
    STRINGID_ABILITYSHIELDPROTECTS,
    STRINGID_TARGETINFECTEDBYMELTVIRUS,
    STRINGID_PKMNHURTBYMELTVIRUS,
    STRINGID_TRASHCRUSHHIT,
    STRINGID_PKMNINFINITEGROWTHGROW,
    STRINGID_PKMNINFINITEGROWTHSTART,
    STRINGID_BUGSPACESTART,
    STRINGID_BUGSPACEPASSIVEOHKO,
    STRINGID_BUGSPACEPASSIVEFAINT,
    STRINGID_KAZURASPOKE,
    STRINGID_TAUNTEDBYKAZURA,
    STRINGID_TAUNTEDBYKAZURA2,
    STRINGID_TAUNTEDBYKAZURAMINIMIZE,
    STRINGID_TAUNTEDBYKAZURAOHKO,
    STRINGID_TAUNTEDBYKAZURA_P_OHKO,
    STRINGID_BUGSPACEKAZURAGRAB,
    STRINGID_BUGSPACEMOVEBLOCKED,
    STRINGID_BUGSPACEKAZURABLOCKEDFIRST,
    STRINGID_BUGSPACEKAZURABLOCKEDREPEAT,
    STRINGID_BUGSPACEKAZURABLOCKEDPOHKO,
    STRINGID_BUGSPACESTATDECAY,
    STRINGID_BUGSPACEKAZURABOOSTDECAY,
    STRINGID_KAZURADROP_GUTS,
    STRINGID_KAZURADROP_GUTS2,
    STRINGID_KAZURADROP_GUTS3,
    STRINGID_KAZURADROP_CQPUNISH,
    STRINGID_CASTORIA_ASKS_NAME,
STRINGID_CASTORIA_TRUE_NAME,
STRINGID_CASTORIA_FALSE_NAME,
STRINGID_CASTORIA_BACKED_OUT,
STRINGID_CASTORIA_COMMANDS_MOVE,
STRINGID_CASTORIA_DYNAMAX_EXPIRE,

...
// Stat settings
#define B_BADGE_BOOST               GEN_1 // In Gen4+, Gym Badges no longer boost a Pokémon's stats. (Gen2 does not include the additional boost to the type matching the gym the badge is from)
...
#define B_FLAG_TERA_ORB_CHARGED     0x23   // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.

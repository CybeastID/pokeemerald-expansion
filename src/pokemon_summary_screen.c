...
static const union AnimCmd sSpriteAnim_TypeDivine[] = {
    ANIMCMD_FRAME(TYPE_DIVINE * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};
...
static const union AnimCmd *const sSpriteAnimTable_MoveTypes[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] = {
    ...
    [TYPE_DIVINE] = sSpriteAnim_TypeDivine,

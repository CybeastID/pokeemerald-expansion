...
const u16 gMetatiles_GiantAliceRoom[] = INCBIN_U16("data/tilesets/primary/giant_alice_room_primary/metatiles.bin");
const u16 gMetatileAttributes_GiantAliceRoom[] = INCBIN_U16("data/tilesets/primary/giant_alice_room_primary/metatile_attributes.bin");

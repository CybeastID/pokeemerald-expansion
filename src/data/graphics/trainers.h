...
const u32 gTrainerFrontPic_Razeluxe[] = INCBIN_U32("graphics/trainers/front_pics/razeluxe.4bpp.lz");
const u32 gTrainerPalette_Razeluxe[] = INCBIN_U32("graphics/trainers/front_pics/razeluxe.gbapal.lz");

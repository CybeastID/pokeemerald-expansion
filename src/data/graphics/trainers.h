...
const u32 gTrainerFrontPic_Razeluxe[] = INCBIN_U32("graphics/trainers/front_pics/razeluxe.4bpp.smol");
const u16 gTrainerPalette_Razeluxe[] = INCBIN_U16("graphics/trainers/front_pics/razeluxe.gbapal");
// const u32 gTrainerFrontPic_Alice[] = INCBIN_U32("graphics/trainers/front_pics/razeluxe.4bpp.smol");
// const u16 gTrainerPalette_Alice[] = INCBIN_U16("graphics/trainers/front_pics/razeluxe.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_RAZELUXE, gTrainerFrontPic_Razeluxe, gTrainerPalette_Razeluxe),
    TRAINER_SPRITE(TRAINER_PIC_ALICE, gTrainerFrontPic_SwimmerF, gTrainerPalette_SwimmerF)
};

...
static void AnimTask_TrashCrush_Step1(u8);
static void AnimTask_TrashCrush_Step2(u8);
...
void AnimTask_TrashCrush(u8 taskId)
{
    u16 win0h = IsContest() ? 152 : DISPLAY_WIDTH;
    u16 win0v = 0;
    ...
    gTasks[taskId].data[0] = win0v;
    gTasks[taskId].data[1] = win0h;
    gTasks[taskId].func = AnimTask_TrashCrush_Step1;
}

static void AnimTask_TrashCrush_Step1(u8 taskId)
{
    ...
    {
        gBattle_WIN0H = 0;
        gTasks[taskId].func = AnimTask_TrashCrush_Step2;
    }
    else
    {
        gBattle_WIN0H = WIN_RANGE(gTasks[taskId].data[0], gTasks[taskId].data[1]);
...
static void AnimTask_TrashCrush_Step2(u8 taskId)
{
    if (++gTasks[taskId].data[10] == 5)
    {
        gTasks[taskId].data[11] = 0x88;
